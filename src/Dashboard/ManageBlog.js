...
const ManageBlog = () => {
    ...
    useEffect(() => {
        fetch('https://venia-cosmetic-sever-side-dkuh-jonied-mirza-shakib.vercel.app/blog')
            .then(res => res.json())
    ...
    const handleDelete=id=>{
        ...
        if(proceed){
            fetch(`https://venia-cosmetic-sever-side-dkuh-jonied-mirza-shakib.vercel.app/blog/${id}`,{
                method:'DELETE'
            })
            .then(res=>res.json())
            .then(data=>{
