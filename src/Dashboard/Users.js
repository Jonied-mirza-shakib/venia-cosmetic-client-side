...
const Users = () => {
    const { data: users, isLoading, refetch } = useQuery('users', () => fetch('https://venia-cosmetic-sever-side-production-0705.up.railway.app/user', {
        method: 'GET',
        headers: {
    ...
    const makeAdmin = email => {
        fetch(`https://venia-cosmetic-sever-side-production-0705.up.railway.app/user/admin/${email}`, {
            method: 'PUT',
            headers: {
