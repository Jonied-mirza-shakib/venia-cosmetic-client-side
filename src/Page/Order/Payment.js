...
const Payment = () => {
    ...
    const { data: orders, isLoading, refetch } = useQuery(['order', id], () => fetch(`https://venia-cosmetic-sever-side-dkuh-jonied-mirza-shakib.vercel.app/order/${id}`, {
        method: 'GET',
        headers: {
